...
const ActivityComplete: React.FC<ActivityCompleteProps> = ({
  ...
  const handleSendEmail = async () => {
    try {
      await axios.post('/api/email-incident', {
        to: recipientEmail,
        // You might pass more details or the entire incident object, so server can format the email
        message: `Incident details for activity ID: ${activityId}...`,
      })
  ...
  return (
    <div className="container mt-4">
      <h3 className="mb-3">
        Complete Activity
        {activityName && <span className="ms-2">- {activityName}</span>}
      </h3>
            ...
            */}
            <div className="row">
              ...
              <div className="col-md-6 mb-3">
                <label className="form-label fw-bold">Type of Incident:</label>
                <select
            ...
            <div className="row">
              ...
              <div className="col-md-6 mb-3">
                <label className="form-label fw-bold">Time of Incident:</label>
                <input
                  className="form-control"
                  type="time"
            ...
            <div className="row">
              ...
              <div className="col-md-6 mb-3">
                <label className="form-label fw-bold">Body Part Injured:</label>
                <input
                  className="form-control"
                  type="text"
            ...
            <div className="row">
              ...
              <div className="col-md-6 mb-3">
                ...
                <input
                  ...
                  onChange={(e) => handleDateChange(e, setManagerSignatureDate)}
                />
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-md-6 mb-3">
                ...
                <input
                  ...
                  onChange={(e) => handleDateChange(e, setCommitteeMeetingDate)}
                />
              </div>
              <div className="col-md-6 mb-3">
